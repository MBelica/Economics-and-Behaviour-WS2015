...
\chapter{Introduction to behavioural and experimental economics} \index{game}
...
First, analysing a game one often determines the optimal strategy by assuming that that the player is an \begriff{homo oeconomicus}. What does this imply? We assume for a homo oeconomicus two main characteristics:
\begin{enumerate}
	\item Rationality
