...
We look at two players in two stages. The first player, the proposer $P$ receives a sum of money $(M = 10)$ and proposes how to divide the sum between himself $(x_{p})$, where $x_{p} \in \{ 0, 1, 2, \dotsc, 10 \}$, and another player, the receiver $R$, who collects $(10 - x_{p})$. The responder chooses to either accept or reject this proposal. If $R$ accepts, the money is split according to the proposal. If the second player reject, neither player receives any money.
