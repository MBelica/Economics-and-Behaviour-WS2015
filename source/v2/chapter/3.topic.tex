...
An extensive form is suitable to model games like this and later we will find not far to seek why it usually has the form of a tree. The definition of a game in extensive form consists of:
