...
\begin{example}[Guessing-Game / Beauty-Contest]
	...
	\textbf{Answer:} Yes. Assume all bidders except for bidder $i$ bid $0$.	
		\begin{itemize}
			...
			and this holds since $b > p \cdot \varnothing$ and further
	...
	1/n (48*100 + x * 0,5) = x <=> 1/n 48*100 = ( 0.99 ) x < = > 
...
here something is missing in my notes %todo missing in my notes
