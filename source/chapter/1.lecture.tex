...
The \begriff{Prisoner's Dilemma} accures e.g. in the following situation: \\
...
\begin{definition}[Strict dominance]
	A strategy $s_{i}''$ is \begriff{strictly dominated} if and only if there exists another strategy $s_{i}'$ such that
...
\begin{example}[Battle of the sexes] \label{battleofthesexes}
		...
		Hence the \begriff{Battle of sexes} in strategic form could look something like:
